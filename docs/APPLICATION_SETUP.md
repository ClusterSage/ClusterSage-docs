...
- Frontend: `apps/frontend`, Next.js dashboard and auth UI.
- Backend/API: `apps/backend`, FastAPI, JWT auth, tenant-scoped cluster/resource/log APIs.
- Agent: `agent/collector`, Python in-cluster collector plus Fluent Bit.
